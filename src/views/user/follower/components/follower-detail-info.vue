<template>
  <div>
    ...
    <a-row justify="space-between">
      <a-col :span="7" style="padding-right:10px;box-sizing: border-box;">
        ...
        <div>
          <a-card style="margin-top: 15px" title="Ticket Change">
            ...
            >
              ...
              <a-timeline-item
                v-for="(record, index) in ticketChangeRecord"
                :key="index"
                line-type="dashed"
              >
                <a-tag>
        ...
        <a-card hoverable style="margin-top: 15px">
              ...
              <a-col :span="7" :offset="1">
                <a-form-item label="E-Project" label-col-flex="110px">
                  <span class="highlighted-text">{{
                    rawRecord.e_project3
                  }}</span>
                </a-form-item>
              </a-col>
              <a-col :span="16">
                <a-form-item label="Country" label-col-flex="110px">
                  <span class="highlighted-text">{{ rawRecord.country }}</span>
                </a-form-item>
              </a-col>
            </a-row>
          ...
          <a-row :gutter="16">
            <a-col :span="7" :offset="1">
              <a-form-item label="group-project" label-col-flex="110px">
                <span class="highlighted-text">{{ rawRecord.project }}</span>
              </a-form-item>
            </a-col>
            <a-col :span="8">
              <a-form-item label="Section" label-col-flex="110px">
                <span class="highlighted-text">{{ rawRecord.sw_causing }}</span>
              </a-form-item>
            </a-col>
            <a-col :span="8">
          ...
          <a-row :gutter="16">
            ...
            <a-col :span="8">
              <a-form-item label="HW" label-col-flex="110px">
                <span class="highlighted-text">{{ rawRecord.hw_causing }}</span>
              </a-form-item>
            </a-col>
            <a-col :span="8">
          ...
          <a-row :gutter="16">
            <a-col :span="7" :offset="1">
              <a-form-item label="Creator" label-col-flex="110px">
                <span class="highlighted-text">{{ rawRecord.creator }} </span>
              </a-form-item>
            </a-col>
          ...
          <a-row :gutter="16">
            <a-col :span="7" :offset="1">
              <a-form-item label="(Syst.-)Supplier" label-col-flex="110px">
                <span class="highlighted-text">{{ rawRecord.supplier }}</span>
              </a-form-item>
            </a-col>
            <a-col :span="16">
              <a-form-item label-col-flex="50px">
          ...
          <a-row :gutter="16">
            <a-col :span="9" :offset="1">
              <a-form-item label="Verification Tester" label-col-flex="120px">
...
<script lang="ts" setup>
  ...
  import { queryTicketChangeRecord } from '@/api/list';
  ...
  const fetchData = async () => {
    ...
    const { data } = await queryTicketChangeRecord(
      rawRecord.value.cluster_type,
      rawRecord.value.number
    );

export default {
  'menu.workspace.follower': 'Subscription',
  'menu.workspace.filter': 'Filter',
  'menu.workspace.taskBoard': 'Task Board',
  'menu.workspace.filterList': 'Filter Manage',
  'menu.workspace.setting': 'User Setting',
  ...
  'userSetting.basicInfo.form.label.username': 'User Name',
  'userSetting.basicInfo.form.label.role': 'Role',
  'userSetting.basicInfo.form.label.department': 'Department',
  'userSetting.basicInfo.form.label.group': 'Group',
  'userSetting.basicInfo.form.label.position': 'Position',
  'userSetting.basicInfo.form.label.phone': 'Phone',
  'userSetting.basicInfo.placeholder.username': `Please enter your username`,
  'userSetting.form.error.email.required': 'Please enter email address',
  'userSetting.form.error.username.required': 'Please enter user name ',
